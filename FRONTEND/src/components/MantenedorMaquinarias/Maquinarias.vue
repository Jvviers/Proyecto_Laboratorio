<script setup>
import { ref } from 'vue';
import AgregarMaquinaria from './AgregarMaquinaria.vue';
import EliminarMaquinaria from './EliminarMaquinaria.vue';
import EditarMaquinaria from './EditarMaquinaria.vue';
...
<template>
	...
	<div v-if="modalAgregar" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
		<div class="bg-white p-4 rounded shadow-lg relative">
			<AgregarMaquinaria :isModalOpen="modalAgregar" @close-modal="toggleModalAgregar" />
		</div>
	</div>
    <div v-if="modalEliminar" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
		<div class="bg-white p-4 rounded shadow-lg relative">
			<EliminarMaquinaria :isModalOpen="modalEliminar" @close-modal="toggleModalEliminar" />
		</div>
	</div>
    <div v-if="modalEditar" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
		<div class="bg-white p-4 rounded shadow-lg relative">
			<EditarMaquinaria :isModalOpen="modalEditar" @close-modal="toggleModalEditar" />
		</div>
	</div>
</template>